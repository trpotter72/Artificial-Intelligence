...
;;*****************************************************************************
;;
;;V5 creates a more beautiful output to (?- inquiry) responses, this is done
;;through an addition and integration of the top-level-prove function
;;
...
(defun show-prolog-vars (vars bindings)
  "Helper function to show-prolog-solutions, prints each var w/ its binding"
  (if (null vars)
      (format t "~&Yes.")
      (dolist (var vars)
        (format t "~&~a = ~a" var
...
(defun top-level-prove (goals)
  ...
  (show-prolog-solutions
    (variables-in goals) (prove-all goals no-bindings)))
